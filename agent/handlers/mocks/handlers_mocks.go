...
// Source: github.com/adamrbennett/amazon-ecs-agent/agent/handlers (interfaces: DockerStateResolver)

package mock_handlers

import (
	dockerstate "github.com/adamrbennett/amazon-ecs-agent/agent/engine/dockerstate"
