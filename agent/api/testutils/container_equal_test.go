...
func TestContainerEqual(t *testing.T) {
	...
	equalPairs := []Container{
		...
		Container{Ports: []PortBinding{PortBinding{1, 2, "1", TransportProtocolTCP}}}, Container{Ports: []PortBinding{PortBinding{1, 2, "1", TransportProtocolTCP}}},
	...
	unequalPairs := []Container{
		...
		Container{Ports: []PortBinding{PortBinding{1, 2, "1", TransportProtocolTCP}}}, Container{Ports: []PortBinding{PortBinding{1, 2, "二", TransportProtocolTCP}}},
		Container{Ports: []PortBinding{PortBinding{1, 2, "1", TransportProtocolTCP}}}, Container{Ports: []PortBinding{PortBinding{1, 22, "1", TransportProtocolTCP}}},
		Container{Ports: []PortBinding{PortBinding{1, 2, "1", TransportProtocolTCP}}}, Container{Ports: []PortBinding{PortBinding{1, 2, "1", TransportProtocolUDP}}},
