...
// Source: github.com/adamrbennett/amazon-ecs-agent/agent/ecr (interfaces: ECRSDK,ECRFactory)

package mock_ecr

import (
	ecr0 "github.com/adamrbennett/amazon-ecs-agent/agent/ecr"
	ecr "github.com/adamrbennett/amazon-ecs-agent/agent/ecr/model/ecr"
...
func (_m *MockECRFactory) GetClient(_param0 string, _param1 string) ecr0.ECRSDK {
	ret := _m.ctrl.Call(_m, "GetClient", _param0, _param1)
	ret0, _ := ret[0].(ecr0.ECRSDK)
	return ret0
}
