...
// Source: github.com/adamrbennett/amazon-ecs-agent/agent/wsclient (interfaces: ClientServer)

package mock_wsclient

import (
	wsclient "github.com/adamrbennett/amazon-ecs-agent/agent/wsclient"
